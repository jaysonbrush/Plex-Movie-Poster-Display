<?php
include 'config.php';
include_once '/var/www/html/assets/plexmovieposter/tools.php';
...
function getPoster($artWorkLocation) {
	...
	// $testMimeData = mime_content_type($imgInfo); // Disabled - PHP 8 fix
	// pmp_Logging("$logName", "\t Test Mime Data: $testMimeData"); // Disabled - PHP 8 fix
